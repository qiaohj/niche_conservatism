...
seqs<-c(1, 1301, 2601, 3901, 5201, 6501, 7801, 9101, 10401, 11601, 12801)
seqs<-c(1299, 1299, 1299, 1299, 1299, 1299, 1299, 1299, 1199, 1199, 119)
...
saveRDS(diversity_se_all_df_se, 
        sprintf("/media/huijieqiao/QNAS/Niche_Conservatism/Data/diversity_items/%s_%s.rda", nb, da))
da<-"GOOD"
saveRDS(diversity_se_all_df_se_xx2, 
        sprintf("../Data/diversity_items_%s_%s.rda", nb, da))

saveRDS(diversity_se_all_df_se2, 
        sprintf("../Data/diversity_items_%s_%s2.rda", nb, da))
