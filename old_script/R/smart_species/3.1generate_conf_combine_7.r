...
simulations<-data.frame(lapply(simulations, function(x) { gsub("_2_", "_7_", x)}))
simulations$niche_breadth_evolution_ratio<-"0.5,0.75,1,1"
simulations$evo_type<-7
mydb <- dbConnect(RSQLite::SQLite(), "/home/huijieqiao/git/ees_3d_data/SMART_SPECIES/conf_7.sqlite")
